    ...
    <div class="main main-app p-3 p-lg-4">
      <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
          ...
          <h4 class="main-title mb-0">Delete Record</h4>
        </div>
      </div>
...
$sql = "DELETE FROM hrm_staffmonsal WHERE SalMon_RwId = '$DelSalId'";

if ($tdconton->query($sql) === TRUE) {
    echo "Record deleted successfully";
} else {
    echo "Error deleting record: " . $tdconton->error;
}
