    ...
    <div class="main main-app p-3 p-lg-4">
      <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
          ...
          <h4 class="main-title mb-0">View Single Data of Leave Register</h4>
        </div>
      </div>
...
<?php
$sqlSelectRecord = "SELECT * FROM hrm_leavreg WHERE LeavReg_RwId = '$VwlrId'";
