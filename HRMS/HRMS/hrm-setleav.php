...
<html lang="en">
  ...
  <body>
    ...
    <form class="needs-validation" action="hrm-setleavA.php" method="POST" autocomplete="off" novalidate>
                <div class="card">
                    <div class="card-body">
            
                        <div class="row">
                            <div class="col-md-6 mb-3">
                            <label for="hrlevnm">Leave Name :</label>
                            <input type="text" id="hrlevnm" name="hrlevnm" maxlength="100" required>
                            <div id="id_result">
                            </div>
                        </div>
                        ...
                        <script>
                            ...
                            $(document).ready(function() {                              
                                $('#hrlevnm').on('keyup', function() { //function is run with the keyup of the keyboard
                        ...
                        <div>
                        <button class="w-24 btn btn-primary btn-lg" type="submit">Go to Add Leave name</button>
                        </div>
                    </div>
                </div>
