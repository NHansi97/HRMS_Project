    ...
    <div class="main main-app p-3 p-lg-4">
      <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
          ...
          <h4 class="main-title mb-0">View Single Data of Holiday</h4>
        </div>
      </div>
...
<?php
$sqlSelectRecord = "SELECT * FROM hrm_holidy WHERE hrm_HoliRwId = '$VwHliId'";
...
?>
                        <div class="row">
                            <div class="col-sm-6">
                            <label for="detCerAwId">Holiday Name :</label>
                            <label for="detCerAwId"><?php echo $selHliNam; ?></label>
            
                        <div class="row">
                            <div class="col-sm-6">
                            <label for="detStuSig">Description :</label>
                            <label for="detCerAwId"><?php echo $selHliDesp; ?></label>
                            </div>
                        </div>
