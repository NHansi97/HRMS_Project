    ...
    <div class="main main-app p-3 p-lg-4">
      <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
          ...
          <h4 class="main-title mb-0">View, All details of Leave</h4>
        </div>
      </div>
...
<table>
    ...
    <tr>
    <?php
$sqlSelectRecord = "SELECT * FROM hrm_setleave ORDER BY hrm_LeaveRwId DESC";
...
if($sqlScriptExecution->num_rows>0) {
    ...
    <td><?php echo $rowidno['hrm_LeaveNam']; ?></td>
    <td>
            <div class="dropdown">
               <button class="ellipsis-btn">&#8942;</button>
               <div class="dropdown-content">
                  <a href="hrm-setleavVwA.php?fida=<?php echo $rowidno['hrm_LeaveRwId']; ?>">Single View</a>
                  <a href="hrm-setleavVwB.php?fidb=<?php echo $rowidno['hrm_LeaveRwId']; ?>">Edit</a>
                  <a href="hrm-setleavVwC.php?fidc=<?php echo $rowidno['hrm_LeaveRwId']; ?>">Delete</a>
               </div>
            </div>
         </td>
