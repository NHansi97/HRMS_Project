    ...
    <div class="main main-app p-3 p-lg-4">
      <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
          ...
          <h4 class="main-title mb-0">View Single Data of Designation</h4>
        </div>
      </div>
...
<?php
$sqlSelectRecord = "SELECT * FROM hrm_setdesig WHERE hrm_DesRwId = '$VwdesId'";
...
?>
                        <div class="row">
                            <div class="col-sm-6">
                            <label for="detCerAwId">Designation Id :</label>
                            <label for="detCerAwId"><?php echo $seldesTd; ?></label>
            
                        <div class="row">
                            <div class="col-sm-6">
                            <label for="detStuSig">Designation Name :</label>
                            <label for="detCerAwId"><?php echo $seldesNm; ?></label>
                            </div>
                        </div>
