    ...
    <div class="main main-app p-3 p-lg-4">
      <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
          ...
          <h4 class="main-title mb-0">View, All details of Departments</h4>
        </div>
      </div>
...
<table>
    ...
    <tr>
    <?php
$sqlSelectRecord = "SELECT * FROM hrm_setdepart ORDER BY hrm_DepRwId DESC";
    ...
    <td>
            <div class="dropdown">
               ...
               <div class="dropdown-content">
                  <a href="hrm-setdepVwA.php?fida=<?php echo $rowidno['hrm_DepRwId']; ?>">Single View</a>
                  <a href="hrm-setdepVwB.php?fidb=<?php echo $rowidno['hrm_DepRwId']; ?>">Edit</a>
                  <a href="hrm-setdepVwC.php?fidc=<?php echo $rowidno['hrm_DepRwId']; ?>">Delete</a>
               </div>
            </div>
         </td>
