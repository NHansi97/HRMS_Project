    ...
    <div class="main main-app p-3 p-lg-4">
      <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
          ...
          <h4 class="main-title mb-0">Update Details of Designation</h4>
        </div>
      </div>
...
?>
                <form class="needs-validation" action="hrm-setdesgVwBUpA.php" method="POST" novalidate autocomplete="off">

            
                        <div class="row">
                            <div class="col-md-6 mb-3">
                            <label for="dhdsId">Designation Id :</label>
                            <input type="text" id="dhdsId" name="dhdsId" value="<?php echo $UpdesId; ?>" readonly>
                            </div>
                        

                        <div class="row">
                            <div class="col-md-6 mb-3">
                            <label for="dhdsnm">Designation Name :</label>
                            <input type="text" id="dhdsnm" name="dhdsnm" value="<?php echo $seldesNm; ?>" maxlength="255" required>
                            <div id="id_result">
                            </div>
                        </div>
                        ...
                        <script>
                            ...
                            $(document).ready(function() {                              
                                $('#dhdsnm').on('keyup', function() { //function is run with the keyup of the keyboard
                                        var idNumber = $(this).val().trim();
                                        if (idNumber != '') {
                                            $.ajax({
                                                url: 'hrm-setdesgAjx.php',
                                                type: 'post',
                                                data: {
                                                  idNumber: idNumber
                                                },
                        ...
                        <div>
                        <button class="w-22 btn btn-primary" type="submit">Update details of Designation</button>
                        </div>
