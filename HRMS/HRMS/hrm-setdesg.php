...
<html lang="en">
  ...
  <body>
    ...
    <div class="main main-app p-3 p-lg-4">
      <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
          ...
          <h4 class="main-title mb-0">Add Designation</h4>
        </div>
      </div>
    ...
    <form class="needs-validation" action="hrm-setdesgA.php" method="POST" autocomplete="off" novalidate>
                <div class="card">
                    <div class="card-body">
            
                        <div class="row">
                            <div class="col-md-6 mb-3">
                            <label for="hrdsnm">Designation :</label>
                            <input type="text" id="hrdsnm" name="hrdsnm" maxlength="100" required>
                            <div id="id_result">
                            </div>
                        </div>
                        ...
                        <script>
                            ...
                            $(document).ready(function() {                              
                                $('#hrdsnm').on('keyup', function() { //function is run with the keyup of the keyboard
                        ...
                        <div>
                        <button class="w-25 btn btn-primary btn-lg" type="submit">Go to Add Designation</button>
                        </div>
                    </div>
                </div>
